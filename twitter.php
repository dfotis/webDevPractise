...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <div class="container">
                <h1 id="noFacebook"> You will not find Stallman on Twitter either! You can read the 
                    <a href="https://stallman.org/twitter.html">reasons</a>written by officially him :)</h1>
            </div>
        </main>
