...
<html lang="en">
    ...
    <body>
        ...
        <nav>
            <div class="menu-bar">
                <div class="container">
                    <div class="menu">
                        <ul class="nav">
                            <li><a class="menu_item" href="home.php">Home</a></li>
        ...
        <main>
            <div class="container">
                <h1 id="noFacebook"> You will not find official Stallman on Facebook! You can read the <a href="https://stallman.org/facebook.html">reasons</a>
                written by officially him :)</h1>
            </div>
        </main>
